...
export function getSvgTag(type: string): string {
    ...
    switch (type) {
        ...
        case 'ReleaseEvent':
            ...
            svgPath = 'M7.73 1.73C7.26 1.26 6.62 1 5.96 1H3.5C2.13 1 1 2.13 1 3.5v2.47c0 .66.27 1.3.73 1.77l6.06 6.06c.39.39 1.02.39 1.41 0l4.59-4.59a.996.996 0 0 0 0-1.41L7.73 1.73zM2.38 7.09c-.31-.3-.47-.7-.47-1.13V3.5c0-.88.72-1.59 1.59-1.59h2.47c.42 0 .83.16 1.13.47l6.14 6.13-4.73 4.73-6.13-6.15zM3.01 3h2v2H3V3h.01z';
            svgNewPath = 'M 1 7.775 V 2.75 C 1 1.784 1.784 1 2.75 1 h 5.025 c 0.464 0 0.91 0.184 1.238 0.513 l 6.25 6.25 a 1.75 1.75 0 0 1 0 2.474 l -5.026 5.026 a 1.75 1.75 0 0 1 -2.474 0 l -6.25 -6.25 A 1.752 1.752 0 0 1 1 7.775 Z m 1.5 0 c 0 0.066 0.026 0.13 0.073 0.177 l 6.25 6.25 a 0.25 0.25 0 0 0 0.354 0 l 5.025 -5.025 a 0.25 0.25 0 0 0 0 -0.354 l -6.25 -6.25 a 0.25 0.25 0 0 0 -0.177 -0.073 H 2.75 a 0.25 0.25 0 0 0 -0.25 0.25 Z M 6 5 a 1 1 0 1 1 0 2 a 1 1 0 0 1 0 -2 Z M 11.9 9.45 a 0.57 0.57 90 0 0 -0.81 -0.81 l -2.26 2.26 l -1.12 -1.12 a 0.57 0.57 90 0 0 -0.81 0.81 l 1.52 1.52 a 0.57 0.57 90 0 0 0.81 0 l 2.66 -2.66 z';
            [svgHeight, svgWidth] = [16, 14];
            [svgNewHeight, svgNewWidth] = [16, 16];
            break;
        case 'WatchEvent':
